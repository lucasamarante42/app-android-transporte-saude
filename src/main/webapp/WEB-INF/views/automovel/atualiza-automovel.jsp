		...
		<div style="margin-top: 30px"
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<div class="panel-title">ATUALIZAÇÃO DE AUTOMÓVEIS</div>
				</div>


				<div class="panel-body">

					<spring:url value="/automovel/atualizarAutomovel"
						var="atualizaAutomovelURL" />

					<form:form class="form-horizontal" modelAttribute="automovel"
						method="POST" action="${atualizaAutomovelURL}">
