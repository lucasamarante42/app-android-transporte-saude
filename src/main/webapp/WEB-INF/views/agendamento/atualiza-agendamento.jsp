		...
		<div style="margin-top: 30px"
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<div class="panel-title">ATUALIZAÇÃO DE AGENDAMENTOS</div>
				</div>


				<div class="panel-body">

					<spring:url value="/agendamento/atualizarAgendamento"
						var="atualizaAgendamentoURL" />

					<form:form class="form-horizontal" modelAttribute="agendamento"
						method="POST" action="${atualizaAgendamentoURL}">
							...
							<div class="controls col-md-6 ">
								...
								<form:select path="idDestinoAgendamento" class="form-control">
									...
									<c:forEach items="${destinos}" var="destino">
										...
										<c:choose>
											<c:when
												test="${destino.idDestino eq agendamento.destino.idDestino}">
							...
							<div class="controls col-md-6 ">
								...
								<form:select path="idMotoristaAgendamento" class="form-control">
									...
									<c:forEach items="${motoristas}" var="motorista">
										<c:choose>
											<c:when
												test="${motorista.idMotorista eq agendamento.motorista.idMotorista}">
							...
							<div class="controls col-md-6 ">
								...
								<form:select path="idAutomovelAgendamento" class="form-control">
									...
									<c:forEach items="${automoveis}" var="automovel">
										...
										<c:choose>
											<c:when
												test="${automovel.idAutomovel eq agendamento.automovel.idAutomovel}">
							...
							<div class="controls col-md-6 ">
								...
								<form:select path="idRotaAgendamento" class="form-control">
									...
									<c:forEach items="${rotas}" var="rota">
										...
										<c:choose>
											<c:when test="${rota.idRota eq agendamento.rota.idRota}">
